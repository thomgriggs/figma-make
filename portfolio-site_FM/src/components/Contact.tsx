...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Demo form - in production this would connect to a backend service
    console.log('Form submitted:', formData);
    alert('Demo form submitted! For real inquiries, please email hello@thomgriggs.com directly.');
              ...
              <CardContent className="p-8">
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Have a project in mind? Fill out the form below (demo) or reach out directly at hello@thomgriggs.com.
                  </p>
                  <div className="mt-2 text-sm text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-3">
                    <strong>Note:</strong> This is a demo form. For real inquiries, please use the email contact method above.
                  </div>
                </div>
